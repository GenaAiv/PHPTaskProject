<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top" style="height: 70px !important">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="{{env('app_url')}}:8000/tracks"><b>Tracks</b></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="{{env('app_url')}}:8000/"><b>Library</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{env('app_url')}}:8000/community"><b>Community</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{env('app_url')}}:8000/support"><b>Support</b></a>
            </li>
        </ul>
